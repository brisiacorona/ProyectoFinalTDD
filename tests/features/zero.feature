...
Scenario: Login into the system
	...
	When I fill in field with id "username" with "moon.prinsses@hotmail.com"
	And I fill in field with id "password" with "mayra"
	And I submit the form

Scenario: Create an appoitment
	Given I go to "http://127.0.0.1:5000/appointments/create/"
	When I fill in field with id "title" with "Cita con el abogado"
...
Scenario: Consult an appoitment
	Given I go to "http://127.0.0.1:5000/appointments/1/"
	Then I see that the element with class "appointment-detail" contains "limpieza dental"
...
Scenario: Delete an appoitment
	Given I go to "http://127.0.0.1:5000/appointments/"
	When I select the appointment with the title "Cita con el abogado"
	And I do click in the button "appointment-delete-link"
	And I go to "http://127.0.0.1:5000/appointments/"
	Then I see that the element with the class "appointment-detail" not contains "Cita con el abogado"
